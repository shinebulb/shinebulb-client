            ...
            <div className="options">
                <div onClick={() => {
                    ...
                    <p>
                        ...
                        {text[settings.language || 0].saved}
                    </p>
                    <span>{text[settings.language || 0].optionDescriptions[0]}</span>
                </div>
                <hr />
                <button onClick={() => more.current.close()}>{text[settings.language || 0].back}</button>
            </div>
        </dialog>
    )
}
