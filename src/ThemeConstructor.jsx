    ...
    return (
        <dialog className="theme" ref={constructor}>
            <div className="themeHeader">
                <div>
                    <label>
                        {text[settings.language || 0].customTheme[0]}<br />
                        <span>({text[settings.language || 0].current}: {localBg})</span>
                    </label>
                    <input type="color" value={localBg} onChange={event => setLocalBg(event.target.value)} />
                </div>
                <div>
                    <label>
                        {text[settings.language || 0].customTheme[1]}<br />
                        <span>({text[settings.language || 0].current}: {localFont})</span>
                    </label>
            ...
            <div className="sample" style={{ backgroundColor: localBg, color: localFont }}>
                ...
                <button
                    ...
                    style={{width: authState.status ? "25%" : "40%", backgroundColor: "transparent", border: `${localFont} 3px solid`}}
                    title={text[settings.language || 0].themeControls[1]}
                >
                ...
                {authState.status && <button
                    ...
                    title={text[settings.language || 0].themeControls[2]}
                >
            ...
            <dialog
                ...
                <div>
                    <p>{text[settings.language || 0].savedStatus[saveStatus]}</p>
